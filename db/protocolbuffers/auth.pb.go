...
var file_auth_auth_proto_rawDesc = []byte{
	...
	,
}
...
var file_auth_auth_proto_goTypes = []interface{}{
	...
	(*AuthUser)(nil), // 1: Auth.AuthUser
}
var file_auth_auth_proto_depIdxs = []int32{
	0, // 0: Auth.AuthService.CreateUser:input_type -> Auth.User
	0, // 1: Auth.AuthService.GetAuthUser:input_type -> Auth.User
	0, // 2: Auth.AuthService.CreateUser:output_type -> Auth.User
	1, // 3: Auth.AuthService.GetAuthUser:output_type -> Auth.AuthUser
...
type AuthServiceClient interface {
	...
	GetAuthUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*AuthUser, error)
}
...
func (c *authServiceClient) GetAuthUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*AuthUser, error) {
	out := new(AuthUser)
	err := c.cc.Invoke(ctx, "/Auth.AuthService/GetAuthUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	GetAuthUser(context.Context, *User) (*AuthUser, error)
}
...
func (*UnimplementedAuthServiceServer) GetAuthUser(context.Context, *User) (*AuthUser, error) {
...
func _AuthService_GetAuthUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Auth.AuthService/GetAuthUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetAuthUser(ctx, req.(*User))
	}
	return interceptor(ctx, in, info, handler)
}
